...
export const sourceReferences = [
  { key: "DUCAR TOR", label: "DUCAR Terms of Reference and policy evidence" },
  { key: "MoWT Manuals", label: "Ministry of Works and Transport road design, construction and maintenance manuals" },
  { key: "MoFPED Budget", label: "Ministry of Finance budget speeches, estimates and framework papers" },
  { key: "World Bank HDM-4", label: "World Bank HDM-4 road user cost and deterioration logic" },
  { key: "OpenStreetMap", label: "OSM road network geometry and classification" },
  { key: "PIARC RAM", label: "PIARC international road asset management case studies" },
];
